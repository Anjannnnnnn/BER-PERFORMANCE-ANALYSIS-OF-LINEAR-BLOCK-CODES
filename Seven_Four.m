...
dictII=mod(de2bi(0:(2^k1)-1)*g,2); % Generating the codewords..........create dictionary with all possible messages and their parity bits matrix(2^k1,n1)

% Create random bitstreams messages matrix N streams-messages of size k
...
for i=1:length(EbN0)
 ...
 yII=(sqrt(EbN0(i))*coded_w7)+randn(N,n1); % Channel out signal with AWGN (Nxn1) matrix
